...
The second example will load GPT sdk, which needs to be authenticated. You can provide the key as \`\`\``gpt.check4key(yourSecretKey)`\`\`\`. More at [episphere.github.io/gpt](https://episphere.github.io/gpt).

```{ojs}
gpt = await import('https://episphere.github.io/gpt/export.js')
gpt.check4key("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")
```
